...
export const ThreeScene: React.FC<ThreeSceneProps> = ({
  ...
  return (
    ...
    >
      ...
      <Katana3D landmarksRef={landmarksRef} isActive={isSamuraiMode && isKatanaDrawn} katanaId={katanaId} />
      <Armor3D landmarksRef={landmarksRef} isActive={isSamuraiMode} armorId={armorId} />
    </Canvas>
  );
};
